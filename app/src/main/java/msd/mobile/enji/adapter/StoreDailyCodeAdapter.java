...
public class StoreDailyCodeAdapter extends RecyclerView.Adapter<StoreDailyCodeAdapter.ViewHolder>{
    private Context context;
    private List<PROC_DAILY_SALES_STORE_CODE> listData;

    public StoreDailyCodeAdapter(Context context) {
        this.context = context;
        listData = new ArrayList<>();
    }

    public void setData(List<PROC_DAILY_SALES_STORE_CODE> listData) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final PROC_DAILY_SALES_STORE_CODE dataModel = listData.get(position);
